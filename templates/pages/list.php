  ...
  <section>
    ...
    <div>
      <form class="settings-form" action="/" method="GET">
        ...
        <div>
          <div>Sortuj po:</div>
          <label>Tytułe: <input name="sortby" type="radio" value="title" <?php echo $by === "title" ? "checked" : ""  ?>></label>
        ...
        <div>
          ...
          <label>20<input name="pagesize" type="radio" value="20" <?php echo $size === 20 ? "checked" : ""   ?>> </label>
        </div>
